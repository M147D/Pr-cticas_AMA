...
import com.example.ama_practica09.flow.AppEvent
import com.example.ama_practica09.flow.AuthSource
import com.example.ama_practica09.flow.LocationSource
import com.example.ama_practica09.flow.PolicyEngine
import com.example.ama_practica09.flow.TimeSource
            ...
            if (evaluacion.permitido) {
                ...
                _events.emit(
                    AppEvent.Notify(
                        ...
                        type = com.example.ama_practica09.flow.NotificationType.ERROR
                    )
                )
            }
        }
