package com.example.ama_practica08.viewmodel

import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import com.example.ama_practica08.data.UsuarioRepository
import com.example.ama_practica08.flow.AppEvent
import com.example.ama_practica08.flow.AuthSource
import com.example.ama_practica08.flow.LocationSource
import com.example.ama_practica08.flow.PolicyEngine
import com.example.ama_practica08.flow.TimeSource
import com.example.ama_practica08.models.AccionAsistencia
import com.example.ama_practica08.models.RegistroAcceso
import com.example.ama_practica08.models.Ubicacion
            ...
            if (evaluacion.permitido) {
                ...
                _events.emit(
                    AppEvent.Notify(
                        ...
                        type = com.example.ama_practica08.flow.NotificationType.ERROR
                    )
                )
            }
        }
