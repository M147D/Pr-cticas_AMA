package com.example.ama_practica07.viewmodel

import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import com.example.ama_practica07.data.UsuarioRepository
import com.example.ama_practica07.flow.AppEvent
import com.example.ama_practica07.flow.AuthSource
import com.example.ama_practica07.flow.LocationSource
import com.example.ama_practica07.flow.PolicyEngine
import com.example.ama_practica07.flow.TimeSource
            ...
            if (evaluacion.permitido) {
                ...
                _events.emit(
                    AppEvent.Notify(
                        ...
                        type = com.example.ama_practica07.flow.NotificationType.ERROR
                    )
                )
            }
        }
