...
data class GeoPoint(
    ...
    companion object {
        ...
        // Centro de la Facultad de Ingeniería Mecánica
        val FACULTAD_MECANICA_CENTER = GeoPoint(
            latitude = -0.209541,
            longitude = -78.489753
        )
    }
...
sealed class GeofenceZone(
    ...
    /**
     * Facultad de Ingeniería Mecánica (20m)
     * Permite registro de asistencia
     * Centro: -0.209541, -78.489753
     */
    class EdificioMecanica(
        center: GeoPoint = GeoPoint.FACULTAD_MECANICA_CENTER,
        name: String = "Facultad de Ingeniería Mecánica"
    ) : GeofenceZone(
        id = "facultad_mecanica",
        name = name,
        center = center,
        radiusMeters = 20f,
        allowsAttendance = true
...
data class GeofenceStatus(
    ...
    val isInsideMecanica: Boolean = false,
    ...
    fun canRegisterAttendance(): Boolean {
        return isInsideEdificioSecundario || isInsideEdificioPrincipal || isInsideMecanica
    }
