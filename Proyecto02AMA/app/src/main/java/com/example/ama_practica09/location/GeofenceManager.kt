 ...
 * - Facultad de Mecánica (20m) - Centro: -0.209541, -78.489753
        ...
        val newStatus = when (event) {
            is GeofenceEvent.Enter -> {
                when (event.zone) {
                    ...
                    is GeofenceZone.EdificioMecanica -> currentStatus.copy(
                        isInsideMecanica = true,
                        isInsideCampus = true,
                        activeZone = if (currentStatus.isInsideAnyEdificio()) currentStatus.activeZone else event.zone,
                        lastEvent = event
                    )
                ...
                when (event.zone) {
                    is GeofenceZone.EdificioSecundario -> currentStatus.copy(
                        ...
                        activeZone = when {
                            ...
                            currentStatus.isInsideMecanica -> GeofenceZone.EdificioMecanica()
